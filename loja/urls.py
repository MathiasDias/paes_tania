...
urlpatterns = [
    ...
    path("pedidos", views.my_orders, name="pedidos"),
    path("loja/add/<int:produto_id>", views.add_carrinho, name="add_carrinho"),
    path("loja/remover/<int:produto_id>", views.rem_carrinho, name="rem_carrinho"),
    ...
    path("pedido/endereço", views.endereço, name="endereço"),
    path("pedido/endereço/salvar", views.salvar_endereço, name="salvar_endereço"),
    ...
    path("loja/carrinho/add/<int:produto_id>", views.add_quantidade, name="add_quantidade"),
    path("loja/carrinho/rem/<int:produto_id>", views.rem_quantidade, name="rem_quantidade"),
    path("loja/ordem/<ordem>/<int:num_pagina>", views.loja_principal, name="loja_ordem"),
    path("loja/categoria/<categoria>/<int:num_pagina>/<ordem>", views.loja_categoria, name="categoria"),
